					...
					// echo '
						// <div class="data_container">
							...
							// <div class="info_container">
								...
								// <form class="edit_img" action="/admin/edit-item.php" method="POST">
								...
								// </form>
								// <form class="edit_img" action="/admin/delete-item.php" method="POST">
									// <input type="hidden" name="img_id" value="'.$id.'">
